export const RESPONSE_MESSAGES = {
  ...
  FRIEND: {
    ...
    LIST_FETCHED: {
      code: 'FRIENDS_FETCHED',
      message: 'Friends list fetched successfully',
    },
    REQUESTS_FETCHED: {
      code: 'REQUESTS_FETCHED',
      message: 'Friends requests fetched successfully',
    },
    MUTUAL_FETCHED: {
      code: 'MUTUAL_FRIENDS_FETCHED',
  ...
  RELATION: {
    ...
    LIST_FETCHED: {
      code: 'RELATIONS_FETCHED',
      message: 'Relations fetched successfully',
    },
    BLOCKED_FETCHED: {
      code: 'BLOCKED_USERS_FETCHED',
      message: 'Blocked users fetched successfully',
    },
    IGNORED_FETCHED: {
      code: 'IGNORED_USERS_FETCHED',
      message: 'Ignored users fetched successfully',
    },
    MUTED_FETCHED: {
      code: 'MUTED_USERS_FETCHED',
      message: 'Muted users fetched successfully',
    },
    NOTE_UPDATED: {
      code: 'RELATION_NOTE_UPDATED',
      message: 'Relation note updated successfully',
    },
    STATS_FETCHED: {
      code: 'RELATION_STATS_FETCHED',
      message: 'Relation stats fetched successfully',
    },
  },
  DM: {
